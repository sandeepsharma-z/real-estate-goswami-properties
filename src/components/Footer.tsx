          ...
          <div>
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm font-light" style={{ color: "hsla(40,20%,98%,0.6)" }}>099999 96451</p>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-accent shrink-0" />
                <p className="text-sm font-light" style={{ color: "hsla(40,20%,98%,0.6)" }}>hello@goswami-properties.com</p>
              </div>
            </div>
        ...
        <div className="border-t pt-8" style={{ borderColor: "hsla(40,20%,98%,0.1)" }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs font-light" style={{ color: "hsla(40,20%,98%,0.4)" }}>
              &copy; 2026 Goswami Properties. All rights reserved.
            </p>
