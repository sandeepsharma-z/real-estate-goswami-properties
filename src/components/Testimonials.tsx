...
const testimonials = [
  {
    quote: "Goswami Properties made our dream home a reality. Their expertise in the luxury market is unmatched, and the personalized service we received was extraordinary.",
  ...
  {
    quote: "As an investor, I trust Goswami Properties for their deep market analysis and strategic guidance. They've helped me build a portfolio worth over $30M.",
    name: "Amara Williams",
